...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SouRce_Google"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : جوجل](https://t.me/SouRce_Google)' ,nil,inline,msg.id_)
return false
end
