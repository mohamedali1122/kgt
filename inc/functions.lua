...
<link href="https://fonts.kgtapis.com/css?family=Harmattan" rel="stylesheet">
...
if redis:get(kgt..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
if not redis:get(kgt..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(kgt..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(kgt..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المدير\n") 
elseif redis:sismember(kgt..'admins:'..ChatID,UserID) then 
...
.."\n• التعديل «» "..(redis:get(kgt..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(kgt..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(kgt..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(kgt..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(kgt..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(kgt..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(kgt..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(kgt..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(kgt..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(kgt..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(kgt..'num_msg_kgt'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(kgt..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(kgt..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(kgt..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(kgt..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(kgt..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(kgt..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(kgt..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(kgt..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(kgt..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(kgt..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(kgt..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(kgt..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(kgt..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(kgt..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(kgt..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(kgt..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(kgt..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(kgt..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(kgt..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(kgt..'num_msg_kgt'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(kgt..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(kgt..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(kgt..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(kgt..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(kgt..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
