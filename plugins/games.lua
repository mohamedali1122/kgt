...
name = katu[math.random(#katu)]
redis:set(Google..':Set_twet:'..msg.chat_id_,name)
...
return '- اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(Google..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️- اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(Google..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(Google.."GAME:CHER"..msg.chat_id_,'مو جبان') 
elseif SENDTEXT:find('عدل') then
redis:set(Google.."GAME:CHER"..msg.chat_id_,'عدل') 
elseif SENDTEXT:find('نشط') then
redis:set(Google.."GAME:CHER"..msg.chat_id_,'نشط') 
...
redis:set(Google.."GAME:CHER"..msg.chat_id_,'مو مسموح') 
