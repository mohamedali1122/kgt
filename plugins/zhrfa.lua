--[[
│Google ﹏ @Kgtbr
تم تطوير وبرمجة السورس من قبل جوجل  ه .
│@Kgtbr
#-------------------------------------------------------------------
]]
...
redis:setex(Google..":ZhrfNow:"..msg.sender_user_id_,500,true)
sendMsg(msg.chat_id_,msg.id_,"| حسننا , الان يمكنك ارسال الاسم ولبعض الرموز المميزه اكتب رموز")    
return false
end

if redis:get(Google..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(Google..":ZhrfNow:"..msg.sender_user_id_)
...
if msg.text and msg.type ~= "pv" and redis:get(Google..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(Google..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
